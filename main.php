...
#center-box {
    ...
    margin: 0 auto;
    font-size:3em; font-family: 'Jeju Gothic'; color:white
}
#right-box {
    height: 100px;
    line-height: 100px;
...
<div id="header">
  <div id="left-box">
    <font style="font-size:4em; font-family:'Jeju Gothic'; color:white"><?echo "D - ".$leftDateAbs;?></font><br>
    <font style="font-size:1em; font-family:'Jeju Gothic'; color:white"><?echo $row1['view'];?></font>
  </div>
  <div id="right-box">
    <font style="font-size:3em; font-family: 'Jeju Gothic'; color:white"><?php echo $nDate;?></font>
  </div>
  <div id="center-box">
    <font><?=$s_row1[0]?></font>
  </div>
...
<div id="wrapper2">
  <div id="left-box3">
    ...
    <div class="table-title">
      <h3 style="text-align:center">< 학습시간 기록 ></h3>
    </div>
  ...
  <div id="right-box2">
    <div class="table-title">
      <h3 style="text-align:center">< 메모장 ></h3>
    </div>
    <?
...
<div id="right-box20">
  <div class="table-title">
    <h3 style="text-align:center ; size:50px">< 메모장 ></h3>
  </div>
  <?
    $query9 = "SELECT notepad FROM notepad";
    $result9 = mysql_query($query9);
...
<div id="subpages">
  <a href="subpages/index.php" style="text-decoration:none ; color:white ; margin-top:30px">
    <div id="subTimer">
      <p><font style="font-size:0.7em"><br></font>모의고사 타이머 서비스</p>
    </div>
  </a>
  <a href="subpages/customizing/index.php" style="text-decoration:none ; color:white ; margin-top:30px">
